...
output = sys.argv[3]
min_support_read_num = sys.argv[4]
print(min_support_read_num)
...
with open(input_file, 'r') as hin:
    for line in hin:
        ...
        supporting_read_num_tumor = F[8]
        
        golden_data_flag = False
        tabix_error_flag = False
        filter_flag = False 
        if not supporting_read_num_tumor.startswith("Supporting_Read_Num_Tumor") \
            and int(supporting_read_num_tumor) < int(min_support_read_num):
            filter_flag = True
