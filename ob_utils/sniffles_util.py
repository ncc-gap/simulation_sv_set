...
if __name__ == "__main__":
    ...
    parser.add_argument("--in_sniffles_tumor_sv", help = "the vcf format file", type = str, required=True)
    parser.add_argument("--in_sniffles_control_sv", help = "the vcf format file", type = str, required=True)
