...
class Bed(object):
    def __init__(self, bed_list):
        ...
        self.name = bed_list[3]
        self.score = self.parse_score(bed_list[4])
        self.o1 = bed_list[5]
        self.svtype = bed_list[6]
        self.filter = bed_list[7]
        self.orig_name1 = bed_list[8]
        self.orig_ref1 = bed_list[9]
        self.orig_alt1 = bed_list[10]
        self.malformedFlag = 0
        self.info1 = bed_list[11]
